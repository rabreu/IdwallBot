...
public class IdwallBot extends TelegramLongPollingBot {
    ...
    public void usageMessage(Update update) {
        this.sendMessage(update.getMessage().getChatId(),
                "Olá, eu sou um robô e fui criado porque minha criadora está participando do processo seletivo na Idwall e parte do processo inclui a implementação destes *comandos*:\n\n" +
                "/NadaPraFazer\n" +
